...
switch ($request_method) {
    case 'GET':
            if (isset($permicao['modeloVisualizar'])) {// verifica se o usuario tem permicao para acessar se tive acessa as funcoes
        ...
        break;
    case 'POST':
            if (isset($permicao['modeloCriar'])) {// verifica se o usuario tem permicao para acessar se tive acessa as funcoes
                $modelo->insert();
            }
    ...
    case 'PUT':
        ...
        break;
    case 'DELETE':
            if (isset($permicao['modeloDeletar'])) {// verifica se o usuario tem permicao para acessar se tive acessa as funcoes
                $modelo_id = intval($_GET["modelo_id"]);
